...
<div>
    <div class="goods">
                        ...
                        <li @click="selectFood(food,$event)" v-for="(food,index) in item.foods" :key="index" class="food-item border-1px">
                            ...
                            <div class="content">
                                ...
                                <div class="cartcontrol-wrapper">
                                    <!-- @cartAdd="_drop"，子组件cartcontrol把数据传给父组件 -->
        ...
        <!-- ref="shopcart" 父组件再把数据传给子组件  @cart-add="_drop"  ref="cartcontrol" :el="el"  -->
...
<script type="text/ecmascript-6">
    ...
    export default{
        ...
        computed: {
            ...
            // 把子组件的数据传到父组件上food.count，父组件与子组件之间的联动
            selectFoods() {
                let foods = [];
